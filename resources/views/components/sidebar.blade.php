<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    class="fixed left-0 top-0 z-50 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-gray-800 lg:static lg:translate-x-0"
        ...
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    {{-- Dashboard --}}
                    <x-sidebar-item :selected="request()->routeIs('dashboard')" title="Dashboard" route="dashboard">
                        <x-slot name="icon">
                    ...
                    {{-- Products --}}
                    <x-sidebar-item :selected="request()->routeIs('products')" title="Products" route="products">
                        <x-slot name="icon">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    {{-- POSs --}}
                    <x-sidebar-item :selected="request()->routeIs('point-of-sales')" title="Point of Sales" route="point-of-sales">
                        <x-slot name="icon">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    {{-- Profile --}}
                    <x-sidebar-item :selected="request()->routeIs('profile.edit')" title="Profile" route="profile.edit">
                        <x-slot name="icon">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
