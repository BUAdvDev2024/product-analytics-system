<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            <button class="z-1 block bg-white p-1.5 shadow-sm dark:bg-boxdark lg:hidden"
                ...
                <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                    <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                        ...
                        <span class="inline-flex size-12 items-center justify-center rounded-full bg-gray-500">
                            <span class="text-xs font-medium text-white">{{ collect(explode(' ', auth()->user()->name))->map(function($segment) { return $segment[0]; })->join('') }}</span>
                        </span>
